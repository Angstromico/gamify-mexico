...
const BingoSingle = ({
  ...
  useEffect(() => {
    ...
    const socket = new WebSocket(`${WS}${socketNumber}/`)
    ...
    socket.onclose = () => {
      console.log(`WebSocket connection closed for socket: ${socketNumber}`)
    }
